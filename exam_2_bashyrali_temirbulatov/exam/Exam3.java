    ...
    public static void main(String[] args) {
        ...
        while(start){
            ...
            for (int i = 0; i < 3; i++) {
                ...
                //Score of each round adn who wins
                ...
                System.out.println("---------------------------------");
                //Добавляем нужные нам значения для результатов
            ...
            for (int i = 0; i < 3; i++) {
                ...
                System.out.println("       | Result:      "+ userResultList[i] + " | Result:     "+ botResultList[i]);
            ...
            //continue to play
            System.out.println("Do you want to play ones more (Y/N)");
            String askContinue = System.console().readLine().toUpperCase();
            if (askContinue.equals("N")) {
                start = false;
            }
